...
public class Room {
	...
	public double getDesiredUnoccupiedTemperature() {
		return this.desiredUnoccupiedTemperature;
	}
	
	public boolean getIsAirConditioningOn() {
		return this.isAirConditioningOn;
	}
	...
	public Room getTopAdjacentRoom() {
		return this.topAdjacentRoom;
	}
	
	public Room getBottomAdjacentRoom() {
		return this.bottomAdjacentRoom;
	}
	
	public Room getLeftAdjacentRoom() {
		return this.leftAdjacentRoom;
	}
	
	public Room getRightAdjacentRoom() {
		return this.rightAdjacentRoom;
	}
	...
	public double getLastGeneralTempChange() {
		return this.lastGeneralTempChange;
	}
